#' Plot Number of different age groups per year
#'
#' This function takes a matrix and a data frame as input, and plots na over the years using ggplot2.
#' @param model_result A list that contains model output. The list should have a "report" component which contains a "na" component representing Number of different age groups per year.
...
#' @examples
#' \dontrun{
#' plot_number_age(na, data.cl)
#' }
plot_number_age <- function(model_result, line_size = 1, line_color = "red", line_type = "solid", facet_ncol = 3, facet_scales = "free" ,se = FALSE, se_color = "red", se_alpha = 0.2){
