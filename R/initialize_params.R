...
#' @param t0 Numeric, theoretical age at length zero (default: 1/60)
...
#' @param a A scaling factor (alpha) that adjusts the vertical position of the growth curve. A larger value of 'a' results in a higher overall growth curve, indicating heavier weight of fish at a given length.(default: exp(-12))
#' @param b A shape factor (beta) that determines the slope of the growth curve. A larger value of 'b' results in faster growth, indicating that the weight of fish increases more rapidly with length.(default: 3)
...
#' @param alpha Numeric, alpha parameter in the stock-recruitment relationship.(default: 400)
#' @param beta Numeric, beta parameter in the stock-recruitment relationship.(default: 10)
